...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_VALUES_UNCHANGED =
            "The values provided are identical to the existing student's details. No changes were made.";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (personToEdit.equals(editedPerson)) {
            throw new CommandException(MESSAGE_VALUES_UNCHANGED);
        }
